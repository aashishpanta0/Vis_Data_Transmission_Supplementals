...
from utils import *
os.environ["CUDA_VISIBLE_DEVICES"] = "-1" # comment this line to use gpu for training
...
def main(args):
    ...
    model.save("gp_super_res_model.keras")
    print("Model saved as 'gp_super_res_model.keras'.")

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train a full-resolution model")
